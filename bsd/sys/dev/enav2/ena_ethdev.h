...
enum ena_flags_t{
    ENA_FLAGS_MSIX_DISABLED = 0,
    ENA_FLAG_MSIX_ENABLED = 1,
    ENA_FLAG_LINK_UP = 3,
};
...
struct __rte_cache_aligned ena_adapter {
	/* OS defined structs */
  ena_eth_dev *edev;

	alignas(RTE_CACHE_LINE_SIZE * 2) struct ena_com_dev ena_dev;
